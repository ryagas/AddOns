					...
					PanelGroup = {
						...
						args = {
							...
							lowerpaneloffset = {
								type = "range",
								order = 3,
								name = "Lower Bar Offset",
								desc = "Vertical offset of the bars on the bottom frame.",
								type = "range",
							...
							lowerpanelmidsize = {
								type = "range",
								order = 4,
								name = "Lower Mid Bar Width",
								desc = "The width of the middle bar on the lower frame.",
								type = "range",
							...
							lowerpanelmidheight = {
								type = "range",
								order = 5,
								name = "Lower Mid Bar Height",
								desc = "The height of the middle bar on the lower frame.",
								type = "range",
							...
							lowerpanelleftsize = {
								type = "range",
								order = 6,
								name = "Lower Left Bar Width",
								desc = "The width of the left bar on the lower frame.",
								type = "range",
								min = 0, max = 1000, step = 0.01,		
							},
							lowerpanelleftheight = {
								type = "range",
								order = 7,
								name = "Lower Left Bar Height",
								desc = "The height of the left bar on the lower frame.",
								type = "range",
								min = 0, max = 200, step = 0.01,		
							},
							lowerpanelleftspacing = {
								type = "range",
								order = 8,
								name = "Lower Left Bar Spacing",
								desc = "The space inbetween the left and middle bars on the lower frame.",
								type = "range",
							...
							lowerpanelrightsize = {
								type = "range",
								order = 9,
								name = "Lower Right Bar Width",
								desc = "The width of the right bar on the lower frame.",
								type = "range",
								min = 0, max = 1000, step = 0.01,		
							},
							lowerpanelrightheight = {
								type = "range",
								order = 10,
								name = "Lower Right Bar Height",
								desc = "The height of the right bar on the lower frame.",
								type = "range",
								min = 0, max = 200, step = 0.01,		
							},
							lowerpanelrightspacing = {
								type = "range",
								order = 11,
								name = "Lower Right Bar Spacing",
								desc = "The space inbetween the right and middle bars on the lower frame.",
								type = "range",
								min = 0, max = 300, step = 0.01,		
							},
						},
					...
					AB1Group = {
						...
						args = {
							bar1enable = {
								...
								order = 1,
								name = ENABLE,
								desc = "Enable this Actionbar",							
							},
							bar1btnmax = {
								order = 2,
								name = "Max Buttons",
								desc = "The amount of buttons to display for this bar.",
								type = "range",
								min = 1, max = 12, step = 1,
							},
							bar1btnsize = {
							...
							bar1btnrows = {
								order = 4,
								name = "Button Rows",
								desc = "The amount of button rows.",
								type = "range",
								min = 1, max = 12, step = 1,
							},
							bar1xspacing = {
							...
							bar1xoffset = {
								...
								desc = "The horizontal offset of button rows.",
								type = "range",
								min = 0, max = 100, step = 1,
							},
							bar1yoffset = {
								...
								desc = "The vertical offset of button columns.",
								type = "range",
								min = 0, max = 100, step = 1,
							},
						},
					...
					MiscGroup = {
						...
						args = {
							hideshapeshift = {
								type = "toggle",
								order = 1,
								name = "Hide ShapeShift Bar",
								desc = "Hide the ShapeShift Bar.",							
							},
							shiftbarbtnsize = {
								order = 2,
								name = "ShapeShift Bar Scale",
								desc = "The scale of the ShapeShift Bar buttons.",
								type = "range",
								min = 1, max = 200, step = 1,
							},
							shiftbarspacing = {
								order = 3,
								name = "ShapeShift Bar Spacing",
								desc = "The spacing inbetween ShapeShift Bar button columns.",
								type = "range",
								min = 0, max = 100, step = 1,
							},
							petbarenable = {
								...
								order = 4,
								name = "Enable Pet Bar",
								desc = "Enable the Pet Bar.",							
							},
							petbarbtnsize = {
								order = 5,
								name = "Pet Bar Scale",
								desc = "The scale of the Pet Bar buttons.",
								type = "range",
								min = 1, max = 200, step = 1,
							},
							petbarbtnrows = {
								order = 6,
								name = "Pet Bar Rows",
								desc = "The amount of Pet Bar button rows.",
								type = "range",
								min = 1, max = 10, step = 1,
							},
							petbarspacing = {
								order = 7,
								name = "Pet Bar Spacing",
								desc = "The spacing inbetween Pet Bar button columns.",
								type = "range",
								min = 0, max = 100, step = 1,
							},
							vehiclebarsize = {
								...
								desc = "The scale of the Vehicle Bar buttons.",
								type = "range",
								min = 1, max = 200, step = 1,
							},
							vehiclebarspacing = {
								order = 9,
								name = "Vehicle Bar Spacing",
								desc = "The spacing inbetween Vehicle Bar button columns.",
								type = "range",
								min = 0, max = 100, step = 1,
							},
						},
					...
					GenGroup = {
						...
						args = {
							...
							bagbarscale = {
								...
								order = 8,
								name = "Bag Bar Scale",
								desc = "Scale of bag bar buttons.",
								min = 1, max = 100, step = 1,
							},
							bagbarspacing = {
								type = "range",
								order = 9,
								name = "Bag Bar Spacing",
								desc = "Spacing inbetween bag bar buttons.",
								min = 1, max = 100, step = 1,
							},
						},
					},
