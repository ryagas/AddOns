...
if L then
L["hunger_drive_power"] = "%d層%s - 需要%d能量！"
L["shard_explosion"] = "爆炸裂片爆炸"
L["shard_explosion_desc"] = "為爆炸顯示獨立的計時條，適合近戰職業選用。"
...
L["cannon_train"] = "槍砲列車"
L["custom_off_firemender_marker"] = "標記格羅姆卡癒火者"
L["custom_off_firemender_marker_desc"] = [=[標記格羅姆卡癒火者為 {rt1}{rt2}{rt3}{rt4}，需要團隊權限或隊長。
|cFFFF0000團隊中只該有一人啟用這選項以避免衝突。|r
|cFFADFF2F提示：如果團隊選擇由你啟用這選項，把滑鼠遊標快速掃過各目標上是最快上標的辦法。|r]=]
L["deforester"] = "焚木機"
L["lane"] = "軌道 %s: %s"
