...
if L then
L["hunger_drive_power"] = "%dx %s - %d minerali alla fine!"
L["shard_explosion"] = "Esplosione Scheggia Esplosiva"
L["shard_explosion_desc"] = "Una barra separata per l'esplosione che puoi abilitare per tracciare il tempo di recupero se sei una classe da mischia."
...
L["custom_off_firemender_marker"] = "Marcatore Curatrice del Fuoco Grom'kar"
L["custom_off_firemender_marker_desc"] = [=[Evidenzia le Curatrici del Fuoco con {rt1}{rt2}{rt3}{rt4}, richiede assistente o capo-incursione.
|cFFFF0000Solo 1 persona nell'incursione dovrebbe attivare questa opzione per evitare conflitti con l'evidenziazione.|r
|cFFADFF2FSUGGERIMENTO: Se l'incursione ha scelto te per questo ruolo, spostare velocemente il mouse sopra i mob è la soluzione più rapida per marcarli.|r]=]
