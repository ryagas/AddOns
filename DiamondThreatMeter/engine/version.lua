...
function DTM_Version_CanAsk()
    ...
    if ( (GetNumGroupMembers() or 0) + (GetNumGroupMembers() or 0) == 0 ) then
        return "NOT_GROUPED";
    end
...
-- ********************************************************************
-- * DTM_Version_CheckReminder()                             - NULL - *
-- ********************************************************************
-- * Arguments:                                                       *
-- *    <none>                                                        *
-- ********************************************************************
...
-- * NULL FUNCTION now that DTM is discontinued.                      *
-- ********************************************************************
...
--[[
    ...
    if ( GetNumGroupMembers() < VERSION_REMINDER_MINSIZE ) then return; end
    StaticPopup_Show("DTM_VERSION_REMINDER");
]]
end

-- ********************************************************************
-- * DTM_Version_SetReminder(waitTime)                       - NULL - *
-- ********************************************************************
-- * Arguments:                                                       *
