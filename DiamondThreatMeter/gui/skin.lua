...
local DTM_DefaultSkins = {
    ...
    version = 2.00, -- Skin system version. If it changes, all previous skins will be deleted and restored to default,
...
local upgradeProtocol = {
    ["1.03"] = function(updatedSkin, name)
                   -- Category changes
