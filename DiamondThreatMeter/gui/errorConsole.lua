...
function DTM_ErrorConsole_OnLoad(errorConsole)
    ...
    -- Children
    self.prevButton = _G[self:GetName().."_PrevButton"];
    self.nextButton = _G[self:GetName().."_NextButton"];
    self.positionText = _G[self:GetName().."_Position"];
    self.headerText = _G[self:GetName().."_Header"];
    self.errorText = _G[self:GetName().."_ErrorText"];
