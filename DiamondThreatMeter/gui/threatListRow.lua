...
function DTM_ThreatListRow_OnLoad(self)
    ...
    -- Grab child frames.
    self.dangerYellowBar = _G[self:GetName().."_DangerYellowBar"];
    self.dangerRedBar = _G[self:GetName().."_DangerRedBar"];
    self.backgroundBar = _G[self:GetName().."_BackgroundBar"];
    self.backgroundBarTexture = _G[self:GetName().."_BackgroundBarTexture"];
    self.clickFrame = _G[self:GetName().."_ClickFrame"];

    -- Grabs elements of the row.
    self.classTexture = _G[self:GetName().."_ClassFrameTexture"];
    self.nameText = _G[self:GetName().."_Name"];
    self.nameSmallText = _G[self:GetName().."_NameSmall"];
    self.threatText = _G[self:GetName().."_Threat"];
    self.tpsText = _G[self:GetName().."_TPS"];
    self.threatPercentText = _G[self:GetName().."_ThreatPercent"];
    self.sparkFrame = _G[self:GetName().."_Spark"];
    self.lightingFrame = _G[self:GetName().."_Lighting"];
    self.lightingTexture = _G[self:GetName().."_LightingTexture"];
...
function DTM_ThreatListRow_InitializeDropDown()
    local row = UIDropDownMenu_GetCurrentDropDown():GetParent();
    local info;
