...
L["Load"] = "Laden"
L["Load module to see other items using this appearance."] = "Dieses Modul laden um andere Gegenstände mit demselben Aussehen anzusehen" -- Needs review
L["Modules"] = "Module"
L["MogIt has loaded! Type \"/mog\" to open it."] = "MogIt wurde geladen! Schreibe \"/mog\", um es zu öffnen."
L["New preview"] = "Neue Vorschau"
L["New Preview"] = "Neue Vorschau"
L["New set..."] = "Neues Set..." -- Needs review
L["No animation"] = "Keine Animation"
L["No module is selected"] = "Es ist kein Modul ausgewählt"
L["Only items you own"] = "Nur Gegenstände, die Du hast" -- Needs review
...
L["Other items using this appearance:"] = "Andere Gegenstände mit demselben Aussehen" -- Needs review
L["Other profiles"] = "Andere Profile"
L["Overwrite set '%s'?"] = "Set '%s' überschreiben?"
L["Preview"] = "Vorschau"
L["Preview %d"] = "Vorschau %d"
L["Preview frame fixed size"] = "Vorschua-Rahmen mit fester Größe" -- Needs review
...
L["Shift-click to add to off hand"] = "Nebenhand hinzufügen mit Umschalt-Klick" -- Needs review
...
L["Use a single preview frame"] = "Einen einzelnen Vorschau-Rahmen benutzen" -- Needs review
L["Use preview frame to dress up"] = "Den Vorschau-Rahmen zum Anziehen nutzen" -- Needs review
L["Weapon enchant"] = "Waffenverzauberung" -- Needs review
