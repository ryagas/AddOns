...
L["Achievement for %s%s|r: %s"] = "Achievement for %s%s|r: %s" -- Requires localization
...
L["Adds a |cff00ff00/fake|r command for generating fake achievements."] = "Adds a |cff00ff00/fake|r command for generating fake achievements." -- Requires localization
...
L["|cffffff00Usage: /fake <id or link> <date in MM/DD/YY format>|r"] = "|cffffff00Usage: /fake <id or link> <date in MM/DD/YY format>|r" -- Requires localization
...
L["Clear Chat Commands"] = "Nettoyer les commandes de chat" -- Needs review
...
L["Custom format (advanced)"] = "Format perso (avanc\195\169)" -- Needs review
...
L["Disable if you completed the achievement."] = "Disable if you completed the achievement." -- Requires localization
L["Disable if you say ding."] = "Disable if you say ding." -- Requires localization
...
L["Fake Achievement"] = "Fake Achievement" -- Requires localization
...
L["Generate fake achievement links."] = "Generate fake achievement links." -- Requires localization
...
L["Invalid achievement ID for %s%d|r."] = "Invalid achievement ID for %s%d|r." -- Requires localization
L["Invalid achievement link provided."] = "Invalid achievement link provided." -- Requires localization
...
L["NoTarget"] = "NoTarget" -- Requires localization
L["Not Capturable"] = "Not Capturable" -- Requires localization
...
L["Not Owned"] = "Not Owned" -- Requires localization
...
L["Reset alt names and their mains."] = "Reset alt names and their mains." -- Requires localization
...
L["Reset Names"] = "Reset Names" -- Requires localization
...
\
|cffff0000This CANNOT be undone.|r" -- Requires localization
...
L["Self"] = "Self" -- Requires localization
