   ...
   groups = {
    ...
    items = {
     ...
     --["Pickpocket Test"] =                               { cat = BASE, type = ITEM, method = NPC, name = GetItemInfo(17056) or "Light Feather", itemId = 17056, npcs = { 3115, 3116, }, chance = 100, repeatable = true, pickpocket = true, }, -- Dustwind Harpy and Dustwind Pillager in Razorwind Canyon (Durotar 50 27)
					...
					-- Toys (Holiday)
					["Crashin' Thrashin' Flyer Controller"] =           { cat = HOLIDAY, type = ITEM, isToy = true, method = USE, name = GetItemInfo(104318) or L["Crashin' Thrashin' Flyer Controller"], itemId = 104318, items = { 116762 }, chance = 50, sourceText = L[""], holidayTexture = CALENDAR_WINTERVEIL, questId = { 6983, 7043 }, },
					["Crashin' Thrashin' Racer Controller"] =           { cat = HOLIDAY, type = ITEM, isToy = true, method = USE, name = GetItemInfo(37710) or L["Crashin' Thrashin' Racer Controller"], itemId = 37710, items = { 116762 }, chance = 50, sourceText = L[""], holidayTexture = CALENDAR_WINTERVEIL, questId = { 6983, 7043 }, },
					["Foot Ball"] =                                     { cat = HOLIDAY, type = ITEM, isToy = true, method = USE, name = GetItemInfo(90888) or L["Foot Ball"], itemId = 90888, items = { 116762 }, chance = 50, sourceText = L[""], holidayTexture = CALENDAR_WINTERVEIL, questId = { 6983, 7043 }, },
					["Fuzzy Green Lounge Cushion"] =                    { cat = HOLIDAY, type = ITEM, isToy = true, method = USE, name = GetItemInfo(116692) or L["Fuzzy Green Lounge Cushion"], itemId = 116692, items = { 21271, 21270 }, chance = 4, sourceText = L["Available starting December 25th"], holidayTexture = CALENDAR_WINTERVEIL, questId = { 8788, 8767 }, christmasOnly = true, },
					["MiniZep Controller"] =                            { cat = HOLIDAY, type = ITEM, isToy = true, method = USE, name = GetItemInfo(46709) or L["MiniZep Controller"], itemId = 46709, items = { 116762 }, chance = 50, sourceText = L[""], holidayTexture = CALENDAR_WINTERVEIL, questId = { 6983, 7043 }, },
     ["Moonfang Shroud"] =                               { cat = HOLIDAY, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(101571) or L["Moonfang Shroud"], itemId = 101571, npcs = { 71992, }, chance = 5, sourceText = L[""], holidayTexture = CALENDAR_DARKMOONFAIRE, },
     ["Moonfang's Paw"] =                                { cat = HOLIDAY, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(105898) or L["Moonfang's Paw"], itemId = 105898, npcs = { 71992, }, chance = 5, sourceText = L[""], holidayTexture = CALENDAR_DARKMOONFAIRE, },
					["Pineapple Lounge Cushion"] =                      { cat = HOLIDAY, type = ITEM, isToy = true, method = USE, name = GetItemInfo(116689) or L["Pineapple Lounge Cushion"], itemId = 116689, items = { 21271, 21270 }, chance = 4, sourceText = L["Available starting December 25th"], holidayTexture = CALENDAR_WINTERVEIL, questId = { 8788, 8767 }, christmasOnly = true, },
					["Safari Lounge Cushion"] =                         { cat = HOLIDAY, type = ITEM, isToy = true, method = USE, name = GetItemInfo(116690) or L["Safari Lounge Cushion"], itemId = 116690, items = { 21271, 21270 }, chance = 4, sourceText = L["Available starting December 25th"], holidayTexture = CALENDAR_WINTERVEIL, questId = { 8788, 8767 }, christmasOnly = true, },
					["Silver-Plated Turkey Shooter"] =                  { cat = HOLIDAY, type = ITEM, isToy = true, method = USE, name = GetItemInfo(116400) or L["Silver-Plated Turkey Shooter"], itemId = 116400, items = { 116404 }, chance = 33, sourceText = L[""], holidayTexture = CALENDAR_PILGRIMSBOUNTY, },
     ["The Heartbreaker"] =                              { cat = HOLIDAY, type = ITEM, isToy = true, method = USE, name = GetItemInfo(50471) or L["The Heartbreaker"], itemId = 50471, items = { 54537, }, chance = 83, groupSize = 5, equalOdds = true, sourceText = L["Can be contained in Heart-Shaped Box, rewarded for defeating the World Event Dungeon during Love is in the Air."], lockDungeonId = 288, },
					["The Pigskin"] =                                   { cat = HOLIDAY, type = ITEM, isToy = true, method = USE, name = GetItemInfo(90883) or L["The Pigskin"], itemId = 90883, items = { 116762 }, chance = 50, sourceText = L[""], holidayTexture = CALENDAR_WINTERVEIL, questId = { 6983, 7043 }, },
					["Zhevra Lounge Cushion"] =                         { cat = HOLIDAY, type = ITEM, isToy = true, method = USE, name = GetItemInfo(116691) or L["Zhevra Lounge Cushion"], itemId = 116691, items = { 21271, 21270 }, chance = 4, sourceText = L["Available starting December 25th"], holidayTexture = CALENDAR_WINTERVEIL, questId = { 8788, 8767 }, christmasOnly = true, },
					-- Toys (2.x)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
     ["Orb of the Sin'dorei"] =                          { cat = TBC, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(35275) or L["Orb of the Sin'dorei"], itemId = 35275, npcs = { 24664, 24744, 24723, 24560, }, chance = 60, sourceText = L[""], },
     ["Time-Lost Figurine"] =                            { cat = TBC, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(32782) or L["Time-Lost Figurine"], itemId = 32782, npcs = { 21838, }, chance = 10, sourceText = L[""], },
					-- Toys (3.x)
     ...
     ["Unusual Compass"] =                               { cat = WOTLK, type = ITEM, isToy = true, method = USE, name = GetItemInfo(45984) or L["Unusual Compass"], itemId = 45984, items = { 46007, }, chance = 20, sourceText = L[""], },
					-- Toys (5.x)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
     ["Ai-Li's Skymirror"] =                             { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(86589) or L["Ai-Li's Skymirror"], itemId = 86589, npcs = { 50821, }, chance = 7, sourceText = L[""], },
     ["Blackflame Daggers"] =                            { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(104302) or L["Blackflame Daggers"], itemId = 104302, npcs = { 73171, }, chance = 100, sourceText = L[""], },
     ["Chalice of Secrets"] =                            { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(86575) or L["Chalice of Secrets"], itemId = 86575, npcs = { 50359, }, chance = 5, sourceText = L[""], },
     ["Eternal Kiln"] =                                  { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(104309) or L["Eternal Kiln"], itemId = 104309, npcs = { 72896, }, chance = 250, sourceText = L[""], },
     ["Farwater Conch"] =                                { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(86581) or L["Farwater Conch"], itemId = 86581, npcs = { 50769, }, chance = 7, sourceText = L[""], },
     ["Gastropod Shell"] =                               { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(98136) or L["Gastropod Shell"], itemId = 98136, npcs = { 68220, }, chance = 150, sourceText = L[""], },
     ["Hozen Beach Ball"] =                              { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(86593) or L["Hozen Beach Ball"], itemId = 86593, npcs = { 50836, }, chance = 7, sourceText = L[""], },
     ["Kang's Bindstone"] =                              { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(86571) or L["Kang's Bindstone"], itemId = 86571, npcs = { 50349, }, chance = 5, sourceText = L[""], },
     ["Mr. Smite's Brass Compass"] =                     { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(86568) or L["Mr. Smite's Brass Compass"], itemId = 86568, npcs = { 50336, }, chance = 10, sourceText = L[""], },
     ...
     ["Pandaren Firework Launcher"] =                    { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(86588) or L["Pandaren Firework Launcher"], itemId = 86588, npcs = { 50817, }, chance = 10, sourceText = L[""], },
