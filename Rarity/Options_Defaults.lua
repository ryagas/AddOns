   ...
   groups = {
    ...
    pets = {
     ...
     ["Spineclaw Crab"] =                                { cat = MOP, type = PET, method = NPC, name = GetItemInfo(104168) or L["Spineclaw Crab"], spellId = 148066, itemId = 104168, npcs = { 73166 }, chance = 60, creatureId = 73366, sourceText = L[""], },
					-- 6.0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
     ["Nightshade Sproutling"] =                         { cat = MOP, type = PET, method = NPC, name = GetItemInfo(118595) or L["Nightshade Sproutling"], spellId = 167394, itemId = 118595, npcs = { 85407, 85408, 85409, 85410, 85411, 85412 }, chance = 1000, creatureId = 83594, sourceText = L["Dropped by Disturbed Podling, which has a chance to spawn when picking herbs at your garrison."], },
     ["Red Goren Egg"] =                                 { cat = MOP, type = PET, method = NPC, name = GetItemInfo(118919) or L["Red Goren Egg"], spellId = 170280, itemId = 118919, npcs = { 85294 }, chance = 1000, creatureId = 85667, sourceText = L["Dropped by Goren Protector, which has a chance to spawn when mining ore at your garrison."], },
    ...
    items = {
     ...
     --["Pickpocket Test"] =                               { cat = BASE, type = ITEM, method = NPC, name = GetItemInfo(17056) or "Light Feather", itemId = 17056, npcs = { 3115, 3116, }, chance = 100, repeatable = true, pickpocket = true, }, -- Dustwind Harpy and Dustwind Pillager in Razorwind Canyon (Durotar 50 27)
					...
					["Fuzzy Green Lounge Cushion"] =                    { cat = HOLIDAY, type = ITEM, method = USE, name = GetItemInfo(116692) or L["Fuzzy Green Lounge Cushion"], itemId = 116692, items = { 21271, 21270 }, chance = 50, sourceText = L["Available starting December 25th"], holidayTexture = CALENDAR_WINTERVEIL, questId = { 8788, 8767 }, christmasOnly = true, },
     ...
     ["Moonfang's Paw"] =                                { cat = HOLIDAY, type = ITEM, method = NPC, name = GetItemInfo(105898) or L["Moonfang's Paw"], itemId = 105898, npcs = { 71992, }, chance = 5, sourceText = L[""], holidayTexture = CALENDAR_DARKMOONFAIRE, },
					["Pineapple Lounge Cushion"] =                      { cat = HOLIDAY, type = ITEM, method = USE, name = GetItemInfo(116689) or L["Pineapple Lounge Cushion"], itemId = 116689, items = { 21271, 21270 }, chance = 50, sourceText = L["Available starting December 25th"], holidayTexture = CALENDAR_WINTERVEIL, questId = { 8788, 8767 }, christmasOnly = true, },
					["Safari Lounge Cushion"] =                         { cat = HOLIDAY, type = ITEM, method = USE, name = GetItemInfo(116690) or L["Safari Lounge Cushion"], itemId = 116690, items = { 21271, 21270 }, chance = 50, sourceText = L["Available starting December 25th"], holidayTexture = CALENDAR_WINTERVEIL, questId = { 8788, 8767 }, christmasOnly = true, },
     ...
     ["The Heartbreaker"] =                              { cat = HOLIDAY, type = ITEM, method = USE, name = GetItemInfo(50471) or L["The Heartbreaker"], itemId = 50471, items = { 54537, }, chance = 83, groupSize = 5, equalOdds = true, sourceText = L["Can be contained in Heart-Shaped Box, rewarded for defeating the World Event Dungeon during Love is in the Air."], lockDungeonId = 288, },
					...
					["Zhevra Lounge Cushion"] =                         { cat = HOLIDAY, type = ITEM, method = USE, name = GetItemInfo(116691) or L["Zhevra Lounge Cushion"], itemId = 116691, items = { 21271, 21270 }, chance = 50, sourceText = L["Available starting December 25th"], holidayTexture = CALENDAR_WINTERVEIL, questId = { 8788, 8767 }, christmasOnly = true, },
					-- Toys (2.x)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
