...
L["Already defeated for %s"] = "准备失败 %s" -- Needs review
L["Already known"] = "已知"
L["Announce"] = "通报"
L["Announcements"] = "通报"
...
L["Dropped by Disturbed Podling, which has a chance to spawn when picking herbs at your garrison."] = "被惊扰的魔荚人掉落，在要塞药圃采集时有几率遇到。" -- Needs review
-- L["Dropped by Disturbed Podling, which has a chance to spawn when picking herbs in Draenor."] = ""
L["Dropped by Elegon in Mogu'shan Vaults (all raid formats except Raid Finder)"] = "在魔古山宝库击败伊拉贡掉落（随机团队除外）" -- Needs review
L["Dropped by Goren Protector, which has a chance to spawn when mining ore at your garrison."] = "蜥蜴人保卫者掉落，在要塞矿井采集时有几率遇到。" -- Needs review
-- L["Dropped by Goren Protector, which has a chance to spawn when mining ore in Draenor."] = ""
