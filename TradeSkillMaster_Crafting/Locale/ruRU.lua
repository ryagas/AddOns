...
L["Profession data not found for %s on %s. Logging into this player and opening the profression may solve this issue."] = "Данные о профессиях для %s на %s не найдены. Вход на персонажа и открытие профессий может решить проблему." -- Needs review
...
L["Visit Vendor"] = "Посетите Торговца" -- Needs review
