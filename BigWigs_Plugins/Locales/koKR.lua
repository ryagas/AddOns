...
L["countdownAt"] = "X초 남았을 때 카운트다운" -- Needs review
L["countdownColor"] = "카운트다운 색상" -- Needs review
L["countdownTest"] = "카운트다운 테스트" -- Needs review
L["countdownVoice"] = "카운트다운 음성" -- Needs review
L["countWipes"] = "전멸 횟수"
...
L["text"] = "글자"
L["textCountdown"] = "텍스트 카운트다운" -- Needs review
L["textCountdownDesc"] = "카운트다운을 하는 동안 시각적으로도 카운트를 보여줍니다." -- Needs review
L["textShadow"] = "글자 그림자"
L["texture"] = "텍스쳐"
L["thick"] = "두껍게"
L["thin"] = "얇게"
