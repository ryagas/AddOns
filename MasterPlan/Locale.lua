...
L == "deDE" and {
	...
	["Followers activating this trait:"] = "Anhänger die diese Eigenschaft auslösen:", -- Needs review
	...
	["Missions of Interest"] = "Interessante Missionen", -- Needs review
	...
	["Using this item replaces a random trait."] = "Die benutzung dieses Items ersetzt eine zufällige Eigenschaft.", -- Needs review
	...
	["You have no followers who activate this trait."] = "Du hast keine Anhänger die diese Eigenschaft auslösen.", -- Needs review
...
L == "esES" and {
	...
	["Missions of Interest"] = "Misiones de Interés ", -- Needs review
...
L == "frFR" and {
	...
	["Followers activating this trait:"] = "Sujets actifs avec ce profil :", -- Needs review
	...
	["Using this item replaces a random trait."] = "Utiliser cet objet pour remplacer aléatoirement un profil.", -- Needs review
	...
	["You have no followers who activate this trait."] = "Vous n'avez pas de sujet avec ce profil.", -- Needs review
...
L == "koKR" and {
	...
	["Followers activating this trait:"] = "이 특성을 가지고 있는 추종자:", -- Needs review
	...
	["Last completed: %s ago"] = "최근 완료: %s 전", -- Needs review
	["Mission duration"] = "임무 완료 시간",
	["Mission expiration"] = "임무 만료 시간",
	["Mission level"] = "임무 레벨",
	["Mission order:"] = "임무 정렬:",
	["Missions of Interest"] = "주요 고소득 임무", -- Needs review
	...
	["%s XP/h"] = "%s 경험치/시간",
	Unignore = "무시 취소",
	["Unused followers:"] = "사용 안한 추종자들:",
	["Using this item replaces a random trait."] = "이 아이템을 사용하면 무작위로 특성중 하나를 대체합니다.", -- Needs review
	["View Rewards"] = "보상 보기",
	["You have no followers to counter this mechanic."] = "이 위협 요소를 상쇄할 추종자가 없습니다.",
	["You have no followers who activate this trait."] = "이 특성을 가진 추종자가 없습니다.", -- Needs review
...
L == "ruRU" and {
	...
	["Missions of Interest"] = "Важные задания", -- Needs review
...
L == "zhTW" and {
	...
	["Mission level"] = "任務等級",
	["Mission order:"] = "任務排序:",
	["Missions of Interest"] = "重點任務", -- Needs review
