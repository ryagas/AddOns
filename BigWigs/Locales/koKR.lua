...
L["COUNTDOWN"] = "카운트다운" -- Needs review
L["COUNTDOWN_desc"] = "활성화하게 되면, 음성 및 시각 카운트다운이 마지막 5초 동안 추가됩니다. 화면 가운데에 크게 \"5... 4... 3... 2... 1...\"이 뜨고 다른 사람이 그 숫자를 읽어주는 것을 상상해보시면 됩니다." -- Needs review
...
L["EMPHASIZE"] = "특수 강조"
L["EMPHASIZE_desc"] = "이 옵션을 활성화하면 이 기술과 관련이 있는 모든 메시지를 크고 더 잘보이게 만들어 강조합니다. 강조된 메시지의 크기나 폰트는 메인 메뉴의 \"메시지\"에서 설정하실 수 있습니다." -- Needs review
...
L["temp61Reset"] = "데이터베이스를 더 효율적으로 만들기 위한 변경사항때문에, 여러분이 설정한 커스텀 색상, 소리와 특정 보스와 관련된 설정이 초기화됩니다, 미안해요 :(" -- Needs review
L["test"] = "테스트"
