...
L["temp61Reset"] = "Devido a uma mudança para deixar meu banco de dados mais eficiente, suas cores, sons e configurações de bosses tiveram de ser reiniciadas. Desculpe :(" -- Needs review
L["test"] = "Testar"
