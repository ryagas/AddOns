...
L["EMPHASIZE_desc"] = "Ativando isso SUPER ENFATIZARÁ qualquer mensagem ou barra associada com esta habilidade de encontro. As mensagens serão maiores, as barras piscarão e terão uma cor diferente, sons serão usados para uma contagem regressiva de quando a habilidade está por vir. Basicamente você vai percebê-la."
...
L["severelyOutdated"] = "|cffff0000Seu Big Wigs está mais de 300 revisões desatualizado! Nós recomendamos IMENSAMENTE que atualize para previnir problemas de sincronismo com outros jogadores!|r"
