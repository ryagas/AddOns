...
L["temp61Reset"] = "Suite à un changement permettant à la base de données d'être plus efficace, vos paramètres (couleurs, sons, boss, ...) ont été réinitialisés, mes excuses :("
L["test"] = "Test"
