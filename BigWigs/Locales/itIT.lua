...
L["temp61Reset"] = "A causa di cambiamenti nel cercare di rendere il mio database più efficiente, tutti i settaggi personalizzati su colori, suoni e impostazioni specifiche per ogni boss sono stati reimpostati, mi spiace :("
L["test"] = "Prova"
