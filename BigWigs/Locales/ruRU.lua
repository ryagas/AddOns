...
L["toggleAnchorsBtn_desc"] = "Показать / спрятать привязки индикаторов для всех типов оповещений" -- Needs review
...
L["VOICE_desc"] = "Если установлен плагин голосового оповещения, эта опция позволит проиграть звуковой файл с предупреждением для вас." -- Needs review
L["warmup"] = "Подготовка"
