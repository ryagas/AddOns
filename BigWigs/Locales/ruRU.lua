...
L["temp61Reset"] = "Из-за изменений в базе данных, для повышения её эффективности, ваши пользовательские цвета, звуки и настройки для боссов были сброшены. Извините."
L["test"] = "Тест"
