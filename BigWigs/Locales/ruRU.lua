...
L["test"] = "Тест"
L["testBarsBtn"] = "Создать тестовый индикатор оповещений" -- Needs review
L["testBarsBtn_desc"] = "Создаёт тестовый индикатор для ваших текущих настроек отображения оповещений BigWigs" -- Needs review
L["thanks"] = "Благодарим следующих лиц за их помощь в различных областях разработки"
L["toggleAnchorsBtn"] = "Индикаторы оповещений" -- Needs review
L["toggleAnchorsBtn_desc"] = "Показать / спрятать индикаторы для всех типов оповещений" -- Needs review
...
L["upToDate"] = "Текущий:"
L["VOICE"] = "Голосовое оповещение" -- Needs review
L["VOICE_desc"] = "Если включен плагин голосового оповещения: проигрывает звуковой файл оповещения" -- Needs review
L["warmup"] = "Подготовка"
