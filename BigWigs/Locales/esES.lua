...
L["temp61Reset"] = "Debido a un cambio para hacer my base de datos más eficiente, tus colores personalizados, sonidos y ajustes específicos de jefes tendrán que ser reajustados, lo siento :("
L["test"] = "Probar"
